<template>
  <view class="dock-wrap">
    <view class="dock-shell ui-card fx-fade-up">
      <view class="dock-item" :class="{ active: active === 'courses' }" @click="goCourses">
        <image
          class="dock-icon-image"
          :src="active === 'courses' ? '/static/icons/book-active.png' : '/static/icons/book-default.png'"
          mode="aspectFit"
        />
        <text class="dock-label">课程</text>
      </view>

      <view class="dock-spacer" />

      <view class="dock-item" :class="{ active: active === 'home' }" @click="goHome">
        <image
          class="dock-icon-image"
          :src="active === 'home' ? '/static/icons/address-book-active.png' : '/static/icons/address-book-default.png'"
          mode="aspectFit"
        />
        <text class="dock-label">主页</text>
      </view>
    </view>
...
function goCourses() {
  replacePage('/pages/teacher/courses')
}

function goAssistant() {
  replacePage('/pages/teacher/assistant')
}
</script>
