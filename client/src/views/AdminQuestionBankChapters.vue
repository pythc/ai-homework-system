...
const handleParentClick = (parentId) => {
  if (hasChildren(parentId)) {
    router.push(
      `/admin/question-bank/courses/${courseId}/textbooks/${textbookId}/chapters/${parentId}`,
    )
    return
  }
  router.push(
    `/admin/question-bank/courses/${courseId}/textbooks/${textbookId}/chapters/${parentId}/questions`,
  )
}
</script>
